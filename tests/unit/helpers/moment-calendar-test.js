...
module('moment-calendar', function(hooks) {
  ...
  test('two args (date, referenceDate)', async function(assert) {
    ...
    await render(hbs`{{moment-calendar date referenceDate timeZone='America/New_York'}}`);
  ...
  test('two args (date, referenceDate) with formats', async function(assert) {
    ...
    await render(hbs`{{moment-calendar date referenceDate formats timeZone='America/New_York'}}`);
  ...
  test('can pass individual formats', async function(assert) {
    ...
    await render(hbs`{{moment-calendar date referenceDate lastDay=lastDay timeZone='America/New_York'}}`);
    assert.equal(this.$().text(), 'Yesterday!');
  });
  ...
  test('with es locale', async function(assert) {
    ...
    await render(hbs`{{moment-calendar date referenceDate locale="es" timeZone='America/New_York'}}`);
  ...
  test('can inline timeZone (Sydney)', async function(assert) {
    ...
    await render(hbs`{{moment-calendar date referenceDate timeZone='Australia/Sydney'}}`);
